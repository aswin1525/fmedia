    ...
    return (
        <Card style={{ marginBottom: '2rem' }}>
            ...
            <div style={{
                ...
                <div style={{ padding: '1rem', backgroundColor: 'var(--surface-color-light)', borderRadius: '8px', textAlign: 'center' }}>
                    <div style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--text-main)' }}>{totalPosts}</div>
                    <div style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Total Posts</div>
                </div>
                <div style={{ padding: '1rem', backgroundColor: 'var(--surface-color-light)', borderRadius: '8px', textAlign: 'center' }}>
                    <div style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--text-main)' }}>{totalUpvotes}</div>
                    <div style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>Upvotes Received</div>
                </div>
                <div style={{ padding: '1rem', backgroundColor: 'var(--surface-color-light)', borderRadius: '8px', textAlign: 'center' }}>
                    <div style={{ fontSize: '2rem', fontWeight: 'bold', color: 'var(--text-main)' }}>{totalReposts}</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
                <div>
                    <h4 style={{ marginBottom: '1rem', color: 'var(--text-main)' }}>Most Common Tags</h4>
                ...
                <div>
                    <h4 style={{ marginBottom: '1rem', color: 'var(--text-main)' }}>Failures by Category</h4>
